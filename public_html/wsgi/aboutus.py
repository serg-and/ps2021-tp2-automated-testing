...
def application(environ, start_response):
    ...
    if 'HTTP_COOKIE' not in environ:
        ...
        if result_session is None:
            ...
            html += '        </nav>\n'
            html += '        <body>\n'
            html += '           <div class="container text-center col-md-9">\n'
            html += '               <p></p>\n'
            html += '               <p>\n'
            html += '                   Rough Road is meer dan je gewone marktplaats, Rough Road creëert een veilige omgeving voor zijn verkopers om zaazaa te verkopen. '
            html += '                   Het bedrijf gaat allemaal om de zaazaa. Voor elk verkochte product kan de verkoper zaazaa punten sparen,'
            html += '                   waarmee verkopers gratis zaazaa kan krijgen dat strijd voor een vrij zaazaa land. Rough Road heeft als doel om samen met zijn verkopers het land vol zaazaa te maken. '
            html += '                   <p><em><b>Are you ready to ride!?</b></em></p>'
            html += '               </p>\n'
            html += '           <div>\n'
            html += '        </body>\n'
